...
{
  public:
    DualMC33926MotorShield(PinName M1DIR, PinName M1PWM, PinName M1FB, 
                           PinName M2DIR, PinName M2PWM, PinName M2FB, 
                           PinName nD2, PinName nSF, float lpf_gain = 0.01, int pwm_period_us = 50) : 
...
#endif /* DualMC33926MotorShield_h */
